...
public class EncryptionUtils {
    ...
    static {
        ...
        // Attempt to revert https://github.com/onebeastchris/Protocol/commit/88a122de252b50488ffce9fa6c18b825c9287080
        if (namedGroups != null && !namedGroups.isEmpty()) {
            System.out.println("Named groups are set to: " + namedGroups);
        }
